...
with tf.device('/cpu:0'):
    model = tf.keras.models.load_model('model_ssfalse_b64_lr0.0001_seqlen64_new_dataset.h5')
root = "./dataset/1"
...
predictions_df.to_csv("predictions_sliding_window_updated_11.csv", index=False)
